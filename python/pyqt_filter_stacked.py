...
#
# Created: Wed Jun 20 21:17:22 2012
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_14 = QtGui.QHBoxLayout(self.poleZero)
        ...
        self.horizontalLayout_14.addWidget(self.pzPlot)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("Settings_32x32.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mfmagPush.setIcon(icon)
        ...
        self.mfoverlayPush.setIcon(icon)
        ...
        self.mfoverlayPush_9 = QtGui.QToolButton(self.mtgroupBox)
        self.mfoverlayPush_9.setIcon(icon)
        self.mfoverlayPush_9.setIconSize(QtCore.QSize(16, 16))
        self.mfoverlayPush_9.setCheckable(True)
        self.mfoverlayPush_9.setObjectName(_fromUtf8("mfoverlayPush_9"))
        self.verticalLayout_5.addWidget(self.mfoverlayPush_9)
        self.mfoverlayPush_10 = QtGui.QToolButton(self.mtgroupBox)
        self.mfoverlayPush_10.setIcon(icon)
        self.mfoverlayPush_10.setIconSize(QtCore.QSize(16, 16))
        self.mfoverlayPush_10.setCheckable(True)
        self.mfoverlayPush_10.setObjectName(_fromUtf8("mfoverlayPush_10"))
        self.verticalLayout_5.addWidget(self.mfoverlayPush_10)
        self.mfoverlayPush_11 = QtGui.QToolButton(self.mtgroupBox)
        self.mfoverlayPush_11.setIcon(icon)
        self.mfoverlayPush_11.setIconSize(QtCore.QSize(16, 16))
        self.mfoverlayPush_11.setCheckable(True)
        self.mfoverlayPush_11.setObjectName(_fromUtf8("mfoverlayPush_11"))
        self.verticalLayout_5.addWidget(self.mfoverlayPush_11)
        self.mfoverlayPush_12 = QtGui.QToolButton(self.mtgroupBox)
        self.mfoverlayPush_12.setIcon(icon)
        self.mfoverlayPush_12.setIconSize(QtCore.QSize(16, 16))
        self.mfoverlayPush_12.setCheckable(True)
        self.mfoverlayPush_12.setObjectName(_fromUtf8("mfoverlayPush_12"))
        self.verticalLayout_5.addWidget(self.mfoverlayPush_12)
        ...
        self.horizontalLayout_16 = QtGui.QHBoxLayout(self.mpoleZero)
        ...
        self.horizontalLayout_16.addWidget(self.mpzPlot)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.mfoverlayPush_9.setToolTip(QtGui.QApplication.translate("MainWindow", "Overlay", None, QtGui.QApplication.UnicodeUTF8))
        self.mfoverlayPush_9.setText(QtGui.QApplication.translate("MainWindow", "...", None, QtGui.QApplication.UnicodeUTF8))
        self.mfoverlayPush_10.setToolTip(QtGui.QApplication.translate("MainWindow", "Overlay", None, QtGui.QApplication.UnicodeUTF8))
        self.mfoverlayPush_10.setText(QtGui.QApplication.translate("MainWindow", "...", None, QtGui.QApplication.UnicodeUTF8))
        self.mfoverlayPush_11.setToolTip(QtGui.QApplication.translate("MainWindow", "Overlay", None, QtGui.QApplication.UnicodeUTF8))
        self.mfoverlayPush_11.setText(QtGui.QApplication.translate("MainWindow", "...", None, QtGui.QApplication.UnicodeUTF8))
        self.mfoverlayPush_12.setToolTip(QtGui.QApplication.translate("MainWindow", "Overlay", None, QtGui.QApplication.UnicodeUTF8))
        self.mfoverlayPush_12.setText(QtGui.QApplication.translate("MainWindow", "...", None, QtGui.QApplication.UnicodeUTF8))
